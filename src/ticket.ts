...
export function report_ticket(report: TaskTerminalReport): TicketId {
  return report.ticket;
}
export function report_task(report: TaskTerminalReport): TaskId {
  return report instanceof TerminalFailureReport
    ? report.failure.task
    : report.result.obligation.task;
}
export function apply_evaluation_report(
  evaluation: EvaluationInstance,
